                    ...
                    <div class="d-flex gap-3 mt-4 banner-btn">
                        <?php if($settings['home_live_demo_link']): ?>
                            <a href="<?php echo e($settings['home_live_demo_link']); ?>"
                                class="btn btn-outline-dark"><?php echo e(__('Live
                                                                                                                                                                                                                                                                                                                                Demo')); ?>
                        ...
                        <?php if($settings['home_buy_now_link']): ?>
                            <a href="<?php echo e($settings['home_buy_now_link']); ?>"
                                class="btn btn-outline-dark"><?php echo e(__('Buy Now')); ?>
...
<?php /**PATH E:\WEB-Development\laragon\www\HR_SACO\codecanyon-boyrJ4Un-hrmgo-hrm-and-payroll-tool\main-file\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>